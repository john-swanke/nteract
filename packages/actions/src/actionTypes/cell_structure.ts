...
export const MERGE_WITH_PREVIOUS_CELL   = "MERGE_WITH_PREVIOUS_CELL";
export const MERGE_WITH_NEXT_CELL       = "MERGE_WITH_NEXT_CELL";
...
export type MergeWithPreviousCell = Action<typeof MERGE_WITH_PREVIOUS_CELL,  MaybeHasCell & { cellType: CellType; cell?: ImmutableCell }>;
export type MergeWithNextCell     = Action<typeof MERGE_WITH_NEXT_CELL,  MaybeHasCell & { cellType: CellType; cell?: ImmutableCell }>;
...
export const mergeWithPreviousCell    = makeActionFunction<MergeWithPreviousCell>   (MERGE_WITH_PREVIOUS_CELL);
export const mergeWithNextCell        = makeActionFunction<MergeWithNextCell>   (MERGE_WITH_NEXT_CELL);
